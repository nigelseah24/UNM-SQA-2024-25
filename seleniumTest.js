...
async function testYouTubeVideoCollectionApp() {
  ...
  try {
    ...
    initialPlayedTime = parseFloat(
      initialPlayedTime.replace("Played seconds: ", "")
    );
    ...
    updatedPlayedTime = parseFloat(
      updatedPlayedTime.replace("Played seconds: ", "")
    );
    ...
    let forwardPlayedTime = parseFloat(
      forwardPlayedTimeText.replace("Played seconds: ", "")
    );
    ...
    let backwardPlayedTime = parseFloat(
      backwardPlayedTimeText.replace("Played seconds: ", "")
    );
    ...
    console.log(
      "Reverted video count after deselecting 'AI':",
      revertedVideoCount
    );
